        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            <li class="with-x" v-if="searchParams.categoryName">
              ...
              <i @click="removeCategoryNameBread">×</i>
            </li>
            <!-- 关键字的面包屑 -->
            <li class="with-x" v-if="searchParams.keyword">
              {{ searchParams.keyword }}
              <i @click="removeKeywordBread">×</i>
            </li>
            <!-- 品牌的面包屑 -->
...
export default {
  ...
  methods: {
    ...
    // 删除关键字的面包屑
    removeKeywordBread() {
      // 置空给服务器带参数的searchParams的keyword
      this.searchParams.keyword = undefined
      // 通知Header清除关键字
      this.$bus.$emit('removeKeywordBread')
      if (this.$route.query) {
    ...
    sort(flag) {
      ...
      let originalSortType = this.searchParams.order.split(':')[1]
      //准备一个新的数值，将来赋值给order
      let newOrder = ' '
      // 综合
